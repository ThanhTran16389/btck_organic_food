...
@section('main-content')
    ...
    <style>
        /* CSS cho hiệu ứng blur và popup */
        .blur {
            filter: blur(5px);
            pointer-events: none;
            user-select: none;
        ...
        #thankYouPopup button.closePopup {
            margin-top: 20px;
            padding: 8px 16px;
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            @if (session('order_success'))
                ...
                const content = document.getElementById('contentToBlur');
                ...
                fetch('{{ route('order.store') }}', {
                    ...
                    .then(data => {
                        ...
                        setTimeout(() => {
                            popup.classList.remove('show');
                            content.classList.remove('blur');
                            window.location.href = '{{ url('/') }}'; // ✅ chuyển về home
                        }, 3000);
                    })
                    .catch(error => {
